        ...
        return (
            <div className="jumbotron jumbotron-fluid">
                <div className="container">
                    ...
                    <p className="lead" id="me">This application was made and designed by Alexander Petroski. Visit my GitHub <a href="https://github.com/Petrovski" target="_blank" rel="noopener noreferrer">here!</a></p>
                </div>
            </div>
        )
    }
